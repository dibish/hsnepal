...
<body>
    <header class="flex justify-between items-center px-4 bg-white py-2 border-b">
    ...
    <section class="relative grid grid-cols-[300px_minmax(900px,_1fr)]">
        <aside class=" bg-gray-50 h-screen border-r">
            <nav class="flex flex-col py-8 space-y-4 pl-4">
                <a class="flex gap-2 items-center" href="{{ route('homestay.dashboard') }}">
                ...
                <a class="flex gap-2 items-center" href="{{ route('homestay.inquiry') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
                        <path
